...
public class SecurityConfig {
    ...
    protected SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        ...
        http.authorizeHttpRequests((requests) -> requests
                ...
                .requestMatchers(GET, "/api/authors").hasAnyAuthority("ROLE_USER")
                .requestMatchers(POST, "/api/authors").hasAnyAuthority("ROLE_ADMIN")
                .requestMatchers(PUT, "/api/authors").hasAnyAuthority("ROLE_ADMIN")
                .requestMatchers(DELETE, "/api/authors/{id}").hasAnyAuthority("ROLE_ADMIN")
                .requestMatchers(GET, "/api/posts").hasAnyAuthority("ROLE_USER")
                .requestMatchers(POST, "/api/posts").hasAnyAuthority("ROLE_ADMIN")
                .requestMatchers(PUT, "/api/posts/{id}").hasAnyAuthority("ROLE_ADMIN")
                .requestMatchers(DELETE, "/api/posts/{id}").hasAnyAuthority("ROLE_ADMIN")
